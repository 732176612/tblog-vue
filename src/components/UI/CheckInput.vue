...
<template>
    <div class="input-group">
        <input id="test" type="text" class="form-control text-input" :class="(IsVerify==true?'':'is-invalid')+' '+ClassVal"
            :placeholder="PlaceholderVal" :pattern="PatternVal" @change="Onchange"
            :readonly="ReadonlyVal?'readonly':false" :required="RequiredVal?'required':false"
