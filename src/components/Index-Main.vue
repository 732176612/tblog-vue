 ...
 * @LastEditTime: 2022-05-22 16:46:45
                ...
                <div class="page-header page-header-small" filter-color="green">
                    ...
                    <div class="container">
                        <div class="content-center">
                            ...
                            <p class="category text-white">{{UserDto.Sign}}</p><a
                                class="btn btn-primary smooth-scroll mr-2 aos-init " href="#contact" data-aos="zoom-in"
                                data-aos-anchor="data-aos-anchor">关注我</a><a class="btn btn-primary aos-init " href="#"
                                data-aos="zoom-in" data-aos-anchor="data-aos-anchor">个人简历</a>
                        </div>
                    </div>
                </div>
            </div>
...
-------------------------*/
    ...
    .section-full-page[filter-color="primary"]:after {
        ...
        background: -webkit-gradient(linear, left bottom, left top, from(rgba(227, 227, 227, 0.26)), to(rgba(3, 169, 244, 0.95)));
        background: linear-gradient(0deg, rgba(227, 227, 227, 0.26), rgba(3, 169, 244, 0.95));
        /* Standard syntax */
    }
    ...
    @media screen and (max-width: 991px) {
        ...
        .sidebar-collapse .navbar-collapse:before {
            ...
            /* For Opera 11.1 to 12.0 */
            /* For Firefox 3.6 to 15 */
            background: -webkit-gradient(linear, left top, left bottom, from(var(--blue)), color-stop(80%, #000));
            background: linear-gradient(var(--blue) 0%, #000 80%);
